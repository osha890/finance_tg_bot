...
ENTER_OPERATION_TYPE = "Введите тип операции"
...
MESSAGES_ACCOUNT = {
    ...
    "enter_name": "Введите название счета",
    "enter_balance": "Введите баланс счета",
    "enter_id": "Введите ID счёта",
...
MESSAGES_CATEGORY = {
    ...
    "enter_type": f"Введите тип категории ({EXPENSES}/{INCOMES})",
    "enter_id": "Введите ID категории",
...
MESSAGES_OPERATION = {
    ...
    "enter_name": "Введите название операции",
    "enter_amount": "Введите сумму операции",
    "enter_id": "Введите ID операции",
    "enter_type": "Введите тип операции",
