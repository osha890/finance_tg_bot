...
ENTER_CATEGORY_TYPE = f"Введите тип категории"
CATEGORY_ADDED = "Категория успешно добавлена"
CATEGORY_DELETED = "Категория успешно удалена. Если к ней были прикреплены операции, они перенесены на дефолтную категорию"
...
ENTER_OPERATION_TYPE = f"Введите тип операции"
